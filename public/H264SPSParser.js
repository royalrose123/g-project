...
function H264SPSParser () {
  ...
  constructor.prototype = {
    parse (pSPSBytes) {
      ...
      if (
        profileIdc === BITWISE100 ||
        profileIdc === BITWISE110 ||
        profileIdc === BITWISE122 ||
        profileIdc === BITWISE244 ||
        profileIdc === BITWISE44 ||
        profileIdc === BITWISE83 ||
        profileIdc === BITWISE86 ||
        profileIdc === BITWISE118 ||
        profileIdc === BITWISE128 ||
        profileIdc === BITWISE138 ||
        profileIdc === BITWISE139 ||
        profileIdc === BITWISE134
      ) {
    ...
    getSizeInfo () {
      ...
      let height = FrameHeightInMbs * BITWISE16 - SubHeightC * (BITWISE2 - spsMap.get('frame_mbs_only_flag')) * (cropTop + cropBottom)
    ...
    getCodecInfo () {
      ...
      let profileCompatibility =
        spsMap.get('profile_compatibility') < BITWISE15
