...
function Settings (props) {
  ...
  }, [changeClockState, clockState, detail, tableList, tableListTemp, tableNumber])
            ...
            {({ validateForm, submitForm, initialValues, values, setFieldValue }) => {
              return (
                <FormikForm>
                  ...
                  >
                    <Modal.Header>
                      <div className={cx('home-settings-confirm-modal__header')}>
                        {confirmModalTextPack.title}
                      </div>
                    </Modal.Header>
                    <Modal.Body>
                      <div className={cx('home-settings-confirm-modal__body')}>
                        {confirmModalTextPack.description}
                      </div>
                    </Modal.Body>
                    <Modal.Footer>
                      <Button
