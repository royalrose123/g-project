...
function MemberDetail (props) {
  ...
  const { isLoaded, response: detail } = useFetcher(null, MemberApi.fetchMemberDetail, { id: memberId })
                    ...
                    >
                      <Form.Group width={640}>
                        ...
                        <Form.Row>
                          ...
                          <Form.Column size='md'>
                            <Form.Row style={{ margin: 0 }}>
                              <Field name='propPlay' render={({ field }) => <Form.Input {...field} />} />
                        ...
                        <Form.Row>
                          ...
                          <Form.Column size='md'>
                            <Field name='averageBet' render={({ field }) => <Form.Input {...field} />} />
                          </Form.Column>
                        </Form.Row>
                      ...
                      <Form.Group width={640}>
                        <Form.Row>
                          ...
                          <Form.Column size='md'>
                            <Field name='actualWin' render={({ field }) => <Form.Input {...field} />} />
                          </Form.Column>
                        </Form.Row>
                        ...
                        <Form.Row>
                          ...
                          <Form.Column size='md'>
                            <Field name='drop' render={({ field }) => <Form.Input {...field} />} />
                          </Form.Column>
                        </Form.Row>
                        ...
                        <Form.Row>
                          ...
                          <Form.Column size='md'>
                            <Field name='overage' render={({ field }) => <Form.Input {...field} />} />
                          </Form.Column>
                        </Form.Row>
                      </Form.Group>
                    </div>
