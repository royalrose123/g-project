      ...
      {standingList.map((standingItem, index) => (
        ...
        >
          {typeof standingItem === 'object' ? (
            ...
            <Svg className={cx('home-table-standing__place-empty')} size={52} data='M39,13 C39,20.367 33.367,26 26,26 C18.633,26 13,20.367 13,13 C13,5.633 18.633,0 26,0 C33.367,0 39,5.633 39,13 Z M0,47.667 C0,39 17.333,34.233 26,34.233 C34.667,34.233 52,39 52,47.667 L52,52 L0,52 L0,47.667 Z' />
          )}
        </button>
      ))}
    </div>
