    ...
    <Modal.Footer>
      <Button
        ...
        onClick={event => {
          ...
          // === TEMP ===
          setTimeout(() => {
            membercardInputRef.current.value = '1234567'
          }, 1000)
          ...
          setTimeout(() => {
            setIsLoading(false)
            setMember(memberCardDetectedMember)
