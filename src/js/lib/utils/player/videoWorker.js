console.log('===== importScripts 0===== :', typeof importScripts);
if ('function' === typeof importScripts) {
    console.log('===== importScripts ===== :', importScripts);
    importScripts("./H264SPSParser.js", "./H264Session.js");
    ...
    console.log("videoWorker receiveMessage");
    ...
    switch (message.type) {
        ...
        if (typeof videoRtpSessionsArray[videoCHID] !== "undefined") {
            videoRtpSessionsArray[videoCHID].remuxRTPData(message.data.rtspInterleave, message.data.header, message.data.payload);
        } else {
            // RTCP包
